...
namespace WindowsFormsAppZaliczenie2
{
    public partial class Stanowisko : Form
    {
        ...
        {
            string queryString = "SELECT * FROM STANOWISKO";
        ...
        {
            // TODO: This line of code loads data into the 'dataSet8.STANOWISKO' table. You can move, or remove it, as needed.
            this.sTANOWISKOTableAdapter.Fill(this.dataSet8.STANOWISKO);
            this.FillComboBox();
        ...
        private void updateDataGrid()
        {
            ...
            cmd.CommandText = "SELECT * FROM STANOWISKO";
        ...
        {
            String sql = "INSERT INTO STANOWISKO(ID, NAZWA) VALUES (:ID, :NAZWA)";
            this.AUD(sql, 0);
            resetAll();
        }
        ...
        {
            String sql = "DELETE FROM STANOWISKO WHERE ID = :ID";
            this.AUD(sql, 2);
            this.resetAll();
        }
        ...
        {
            String sql = "UPDATE STANOWISKO SET NAZWA = :NAZWA WHERE ID = :ID";
            this.AUD(sql, 1);
            resetAll();
        }
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            String queryString = "SELECT ID FROM STANOWISKO WHERE NAZWA = " + "\'" + comboBox1.SelectedItem.ToString() + "\'";
